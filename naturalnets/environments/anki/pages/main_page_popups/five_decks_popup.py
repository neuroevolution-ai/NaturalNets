...
class FiveDecksPopup(Page, RewardElement):
    """
    This popup appears when the user tries to create a deck when
    there are already 5 decks present warning the user it is not
    allowed to create more than 5 decks
    State description:
