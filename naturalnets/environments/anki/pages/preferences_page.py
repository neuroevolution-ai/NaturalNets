...
class PreferencesPage(RewardElement,Page):
    ...
    def __init__(self):
        ...
        self.basic_window_show_play_buttons_checkbox = CheckBox(self.BASIC_WINDOW_1_CHECKBOX_BB, self.register_selected_reward(["basic_window_show_play_buttons_checkbox", not(self.basic_window_show_play_buttons_checkbox.is_selected)]))
        self.basic_window_interrupt_audio_checkbox = CheckBox(self.BASIC_WINDOW_2_CHECKBOX_BB, self.register_selected_reward(["basic_window_interrupt_audio_checkbox", not(self.basic_window_interrupt_audio_checkbox.is_selected)]))
        self.basic_window_paste_clipboard_images_checkbox = CheckBox(self.BASIC_WINDOW_3_CHECKBOX_BB, self.register_selected_reward(["basic_window_paste_clipboard_images_checkbox", not(self.basic_window_paste_clipboard_images_checkbox.is_selected)]))
        self.basic_window_paste_without_shift_key_checkbox = CheckBox(self.BASIC_WINDOW_4_CHECKBOX_BB, self.register_selected_reward(["basic_window_paste_without_shift_key_checkbox", not(self.basic_window_paste_without_shift_key_checkbox.is_selected)]))
        self.basic_window_night_mode_checkbox = CheckBox(self.BASIC_WINDOW_5_CHECKBOX_BB, self.register_selected_reward(["basic_window_night_mode_checkbox", not(self.basic_window_night_mode_checkbox.is_selected)]))
        ...
        self.scheduling_window_show_next_review_time_checkbox = CheckBox(self.SCHEDULING_WINDOW_NEXT_DAY_INCREMENT_BB, self.register_selected_reward(["scheduling_window_show_next_review_time_checkbox", not(self.scheduling_window_show_next_review_time_checkbox.is_selected)]))
        self.scheduling_window_remaining_card_count_checkbox = CheckBox(self.SCHEDULING_WINDOW_REMAINING_CARD_COUNT_BB, self.register_selected_reward(["scheduling_window_remaining_card_count_checkbox", not(self.scheduling_window_remaining_card_count_checkbox.is_selected)]))
        self.scheduling_window_legacy_timezone_checkbox = CheckBox(self.SCHEDULING_WINDOW_LEGACY_TIMEZONE_BB, self.register_selected_reward(["scheduling_window_legacy_timezone_checkbox", not(self.scheduling_window_legacy_timezone_checkbox.is_selected)]))
        self.scheduling_window_v3_scheduler_checkbox = CheckBox(self.SCHEDULING_WINDOW_V3_SCHEDULER_BB, self.register_selected_reward(["scheduling_window_v3_scheduler_checkbox", not(self.scheduling_window_v3_scheduler_checkbox.is_selected)]))
