...
CALCULATOR_WIDGETS = {
  ...
  n.CALC_OPERATOR_DROPDOWN: {
    ...
    "args": {
      ...
      "constraints": {
        n.CALC_OPERATOR_ADD: n.SETTINGS_CALCULATOR_ADD,
        n.CALC_OPERATOR_SUB: n.SETTINGS_CALCULATOR_SUB,
        n.CALC_OPERATOR_MULT: n.SETTINGS_CALCULATOR_MULT,
        n.CALC_OPERATOR_DIV: n.SETTINGS_CALCULATOR_DIV
      }
    }
  },
